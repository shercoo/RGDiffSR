...
def sample(path, ocr_data, n):
    if ocr_data:
        ...
        txzm = lmdbDataset_real(root='/home/zhouyuxuan/latent-diffusion/textzoom/' + path, voc_type='all')
    items = []
    idx = []
...
if __name__ == '__main__':
    ...
    txzm = lmdbDataset_real(root='/home/zhouyuxuan/latent-diffusion/textzoom/test/easy' , voc_type='all')
    img_HR, img_lr, img_HRy, img_lry, label_str = txzm.__getitem__(21)
    img_lr = img_lr.resize((128, 32))
    img_HR = img_HR.resize((128, 32))
    mask=toMask(img_lr)
    print(mask)
    img_lr.save('/home/zhouyuxuan/latent-diffusion/a.png')
    mask.save('/home/zhouyuxuan/latent-diffusion/b.png')
    img_HR.save('/home/zhouyuxuan/latent-diffusion/c.png')
